...
## Содержание
 ...
 3. [Chapter III](#chapter-iii)      
     ...
     - [Задание 1-1. Создание структуры проекта](#задание-1-1-создание-структуры-проекта)
     - [Задание 1-2. Реализация domain-слоя](#задание-1-2-реализация-domain-слоя)  
     - [Задание 1-3. Реализация datasource-слоя](#задание-1-3-реализация-datasource-слоя)  
     - [Задание 1-4. Реализация web-слоя](#задание-1-4-реализация-web-слоя)  
     - [Задание 1-5. Реализация di-слоя](#задание-1-5-реализация-di-слоя)
     - [Задание 2-1. Добавление базы данных](#задание-2-1-добавление-базы-данных)    
     - [Задание 2-2. Добавление авторизации](#задание-2-2-добавление-авторизации)  
     - [Задание 2-3. Добавление логики игры между двумя игроками](#задание-2-3-добавление-логики-игры-между-двумя-игроками)
     - [Задание 3-1. Изменение basic-авторизации на jwt](#задание-3-1-изменение-basic-авторизации-на-jwt)
     - [Задание 3-2. Добавление поддержки истории игр](#задание-3-2-добавление-поддержки-истории-игр)
     - [Задание 3-3. Добавление поддержки таблицы лидеров](#задание-3-3-добавление-поддержки-таблицы-лидеров)    
